...
export const yujimai = Yuji_Mai({ subsets: ["latin"], variable: "--yujimai", weight: ["400"] });
export const greatvibes = Great_Vibes({ subsets: ["latin"], variable: "--greatvibes", weight: ["400"] });
